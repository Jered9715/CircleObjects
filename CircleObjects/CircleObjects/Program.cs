using CircleObjects;
    ...
    while (true)
    {
        ...
        Console.WriteLine($"Diameter: {userRadius.CalculateDiameter}");
        //using new circle object use method to display Circumference
        Console.WriteLine($"Circumference: {userRadius.CalculateCircumference}");
        //using new circle object use method to display Area
        Console.WriteLine($"Area: {userRadius.CalculateArea}");
        ...
        {
            Console.WriteLine($"The circle's final radius is {userRadius}");
            break;
        }
    }
